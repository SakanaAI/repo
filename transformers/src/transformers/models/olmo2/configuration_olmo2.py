...
class PEConfig(PretrainedConfig):
    def __init__(self,
                 dynamic_pe_mode=DynamicPeMode.N,
                 dynamic_pe_start_layer=0,
                 dynamic_pe_layer_ids="",
                 dynamic_pe_init_pdrop=1.0,
                 dynamic_pe_dropout_anneal_step=0,
                 **kwargs):
        super().__init__(**kwargs)
        self.dynamic_pe_mode = str(dynamic_pe_mode)
        self.dynamic_pe_start_layer = dynamic_pe_start_layer
        self.dynamic_pe_layer_ids = dynamic_pe_layer_ids
        self.dynamic_pe_init_pdrop = dynamic_pe_init_pdrop
        self.dynamic_pe_dropout_anneal_step = dynamic_pe_dropout_anneal_step
...
class Olmo2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pe_config = PEConfig(**kwargs.get("pe_config", {}))
