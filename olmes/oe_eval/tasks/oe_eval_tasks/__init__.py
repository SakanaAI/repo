...
from .nlgraph import create_core_nlgraph_tasks
from .lost_in_the_middle import create_core_lost_in_the_middle_tasks
from .longbench import create_core_long_bench_tasks
from .wikitableqa import create_core_wikitableqa_tasks
...
TASK_REGISTRY: Dict[str, Type[Task]] = {
    ...
    **create_core_nlgraph_tasks(),
    **number_reading.create_core_number_reading_tasks(),
    **create_core_lost_in_the_middle_tasks(),
    **create_core_wikitableqa_tasks(),
    "hybridqa": hybridqa.GenericHybridQA,
    **create_core_long_bench_tasks(),
}
