...
from typing import Callable, Literal, Optional, Protocol, Union, overload, List
...
def make_layers(
    ...
    if dynamic_pe_mode_list:
        modules = torch.nn.ModuleList(
            [PPMissingLayer() for _ in range(start_layer)] + [
                maybe_offload_to_cpu(layer_fn(prefix=f"{prefix}.{idx}", dynamic_pe_mode=dynamic_pe_mode_list[idx]))
